<script>
  ...
  let paddle = { x: CANVAS_WIDTH / 2 - 40, y: CANVAS_HEIGHT - 20, width: 80, height: 10 };
  let ball = { x: CANVAS_WIDTH / 2, y: CANVAS_HEIGHT / 2, radius: 5, dx: 2, dy: -2 };
  ...
  function initializeBricks() { /* ... setup your skills as bricks ... */ }
  function updateGame() { /* ... move ball, handle collisions ... */ }
  function drawGame() { /* ... draw ball, paddle, bricks on ctx ... */ }
